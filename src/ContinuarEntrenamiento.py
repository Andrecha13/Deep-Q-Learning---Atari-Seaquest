...
# La exploración continuará decayendo desde su valor actual (~0.0109)
...
if __name__ == "__main__":
    ...
    # 🚨 FIX CRÍTICO 1: Forzar la transposición a Channels-Last para evitar el ValueError en el buffer.
    # Esto asegura que el observation_space usado por el ReplayBuffer esté en el formato (H, W, C).
